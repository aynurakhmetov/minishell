...
SRCS =	test.c get_next_line.c get_next_line_utils.c SRC/ft_choice.c SRC/ft_echo.c SRC/ft_cd.c SRC/ft_pwd.c SRC/ft_export.c SRC/ft_env.c SRC/ft_unset.c \
		SRC/ft_exit.c SRC/ft_s_result.c SRC/ft_execve.c SRC/ft_export_set.c SRC/ft_pipe.c SRC/ft_redir.c init.c function.c main_parser.c variable.c \
		function2.c quotes_parser.c parser_check.c parser_check2.c
